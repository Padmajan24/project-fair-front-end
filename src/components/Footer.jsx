...
const Footer = () => {
  ...
  <div className="d-flex justify-content-between">
    ...
    <div style={{width:'400px'}} className="intro">
      <h5><i class="fa-brands fa-docker me-1"></i>Project Fair</h5>
    ...
    <div className="links d-flex flex-column">
      ...
      <Link to={'/Login'} style={{textDecoration:'none',color:'white'}}>Home page</Link>
      <Link to={'/Register'} style={{textDecoration:'none',color:'white'}}>Watch History Page</Link>
    </div>
